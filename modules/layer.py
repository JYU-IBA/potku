...
class Layer:
    ...
    __slots__ = "elements", "thickness", "ion_stopping", "recoil_stopping", "density"
    ...
    def __init__(self, elements, thickness, ion_stopping, recoil_stopping,
        ...
        Args:
            elements:        A list of tuples that contain the element, the isotope
                             and amount, eg. ("O", 16.00, 0.13).
