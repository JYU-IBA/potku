...
class Detector:
    ...
    __slots__ = "name", "description", "date", "detector_type", "calibration", "foils", \
                ...
                "detector_fii", "detector_theta"

    def __init__(self, path, name="Default", description="This a default "
                                                         "detector.",
                 modification_time=time.time(), detector_type="TOF",
    ...
    def create_folder_structure(self, directory):
        ...
        self.efficiency_directory = os.path.join(self.path,
                                                 "Efficiency_files")
